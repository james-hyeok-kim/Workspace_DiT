...
#
# Compares against:
#   BASELINE: results/quip_experiment/BASELINE  (NVFP4_DEFAULT_CFG)
#   A1:       results/w3a4_experiment/W3A4       (GPTQ global scale)
# ============================================================
...
echo "============================================================"
echo "  Timestep-Aware PTQ W4A4 Ablation"
echo "  Started: $(date '+%Y-%m-%d %H:%M:%S')"
echo "  NUM_SAMPLES=${NUM_SAMPLES}  LOWRANK=${LOWRANK}  RANK_T=${RANK_T}"
echo "============================================================"

# ---- [A2] TSAWARE G3, no correction ----
A2_SAVE="${BASE_DIR}/results/ts_aware_experiment/TSAWARE_G3_NOCORR"
echo ""
...
# ---- [A3] TSAWARE G5, no correction ----
A3_SAVE="${BASE_DIR}/results/ts_aware_experiment/TSAWARE_G5_NOCORR"
echo ""
...
A4_SAVE="${BASE_DIR}/results/ts_aware_experiment/TSAWARE_G3_RANK4"
echo ""
...
A5_SAVE="${BASE_DIR}/results/ts_aware_experiment/TSAWARE_G5_RANK4"
echo ""
...
entries = [
    ...
    ("A1 GPTQ global scale (NVFPw-INT4a)",
     load(f"{base}/results/w3a4_experiment/W3A4/{ds}/metrics.json")),
    ("A2 TSAWARE G3 no-corr (NVFPw-INT4a)",
     load(f"{base}/results/ts_aware_experiment/TSAWARE_G3_NOCORR/{ds}/metrics.json")),
    ("A3 TSAWARE G5 no-corr (NVFPw-INT4a)",
     load(f"{base}/results/ts_aware_experiment/TSAWARE_G5_NOCORR/{ds}/metrics.json")),
    ("A4 TSAWARE G3 rank4 (NVFPw-INT4a)",
     load(f"{base}/results/ts_aware_experiment/TSAWARE_G3_RANK4/{ds}/metrics.json")),
    ("A5 TSAWARE G5 rank4 (NVFPw-INT4a)",
...
# Save summary JSON
results_dir = f"{base}/results/ts_aware_experiment"
