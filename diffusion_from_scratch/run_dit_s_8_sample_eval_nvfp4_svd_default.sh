...
QUANT_METHOD="NVFP4_SVDQUANT_DEFAULT_CFG"

MODEL_PATH="${DATA_DIR}/CIFAR_DiT-S-8_20260227_0925/model/model_epoch_1900.pt"
OUTPUT_DIR="${BASE_DIR}/output_eval_dit_b_8_${QUANT_METHOD}/CIFAR_DiT-S-8_20260227_0925/model/model_epoch_1900/"
...
# 2. 평가 스크립트 실행
# (참고) NVFP4 양자화 시뮬레이션을 켜려면 아래 명령어 끝에 --apply_nvfp4 를 추가하세요.
